document.addEventListener("DOMContentLoaded", function () {
    let nextArticle = {
	    ...
	    this.start = 10;
            ...
            this.currentArticleId = this.articleData["currentArticleId"];
            this.currentArticlePrimarySection = this.articleData["currentArticlePrimarySection"];
        ...
        loadNextArticles: function (e) {
            if (
                ...
                $.ajax({
                    url: "/ajax/post/get-next-storyv2",
                    type: "POST",
                    data: {
                        ...
                        currentArticlePrimarySection : this.currentArticlePrimarySection
                    },
                    dataType: "json",
                    success: (response) => {
            ...
            document
                ...
                .insertAdjacentHTML(
                    ...
                    '<div id="pr-reply-to-section" class="row">\n' +
                        ...
                        '<div id="pr-reply-to-content" class="pr-reply-to-content col-12 f14">You\n' +
                        "are replying to\n" +
		...
		if (comment_count < 10) {
			...
			$("#more-comment").html('<a id="more-comment" href="javascript:void(0)" data-id="10" class="view-more f14" rel="sponsored nofollow">View more ('+rem_rec+') comments</a>');
                ...
                $.ajax({
                    url: "/ajax/post/get-commentsv2",
                    type: "POST",
                    data: { articleId: this.currentArticleId, start: this.start },
                    dataType: "json",
                    success: (response) => {
        ...
        onViewReplies: function (e) {
            $.ajax({
                url: "/ajax/post/get-repliesv2",
                type: "POST",
                data: { articleId: this.currentArticleId, parent_id: e.target.id },
                dataType: "json",
                success: (response) => {
